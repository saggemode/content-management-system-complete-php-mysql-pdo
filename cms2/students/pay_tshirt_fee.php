            ...
            <div class="col-md-9">
                ...
                <hr>
                    ...
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="fa fa-tachometer"></i>
                                    Dashboard</a>
                            </li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="col-sm-6">
                                <h3 class="text-primary float-left">Pay TShirt Fee</h3>
                            </div>
                            <br> <br>
                            ...
                            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                ...
                                $check_query = $con->prepare('SELECT * FROM shirt_invoice WHERE confirmation_code = ?');
                                $check_query->execute(array($confirm));


                                if ($check_query->rowCount() > 0) {
                                    header('location: tshirt_receipt.php');
                                }else{
