                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                            ...
                            $check_query = $con->prepare('SELECT * FROM carnival_invoice WHERE confirmation_code = ?');
                            $check_query->execute(array($confirm));


                            if ($check_query->rowCount() > 0) {
                                header('location: carnival_receipt.php');
                            } else {
                        ...
                        <form action="" method="POST" role="form" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="status" class="text-primary">Payment Platform</label>
                                    <select class="form-control" name="platform" id="platform">
                                        <option value="atm">ATM</option>
                                        <option value="nd2">Paypal</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="status" class="text-primary">Paypal number/ ATM TOKEN</label>
